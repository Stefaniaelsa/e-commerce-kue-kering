...
<aside class="w-64 bg-pink-200 p-6 flex flex-col">
    ...
    <div class="flex flex-col items-center mb-8">
        <img src="{{ asset('images/admin.jpg') }}" alt="Foto Profil" class="w-20 h-20 rounded-full mb-2 shadow">
        <p class="text-sm font-medium">Admin</p>
    </div>
    <nav class="space-y-4">
        <a href="/dashboard" class="flex items-center text-[#4e3d3a] hover:text-pink-700">

    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      @forelse ($bestSellerProduk as $produk)
        <div class="bg-white rounded-lg shadow hover:shadow-lg transition p-4">
          ...
          <a href="{{ route('produk.detail', ['id' => $produk->id]) }}" class="mt-2 block text-center bg-pink-500 hover:bg-pink-600 text-white py-1 px-4 rounded text-sm">Lihat Produk</a>
        </div>
      @empty
